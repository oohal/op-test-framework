...
class QemuConsole():
    ...
    def close(self):
        ...
        try:
            ...
            self.state = ConsoleState.DISCONNECTED
            raise Exception("Qemu Console: failed to close console")
...
from .OpTestConsole import OpTestConsole
...
class NewQemuConsole(OpTestConsole):
    def __init__(self):
        self.qemu_pty = None
        super().__init__()
